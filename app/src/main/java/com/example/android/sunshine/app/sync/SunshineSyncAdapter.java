...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void updateMuzei() {
        // Muzei is only compatible with Jelly Bean MR1+ devices, so there's no need to updateWatchFace the
    ...
    private void updateWearable() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            WearableUpdaterService.updateWatchFace(getContext());
        }
    }

    private void notifyWeather() {
        Context context = getContext();
        //checking the last updateWatchFace and notify if it' the first of the day
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    // WEATHER_NOTIFICATION_ID allows you to updateWatchFace the notification later on.
