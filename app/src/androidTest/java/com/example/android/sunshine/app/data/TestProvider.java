...
public class TestProvider extends AndroidTestCase {
    ...
    /*
        This test uses the provider to insert and then updateWatchFace the data. Uncomment this test to
        see if your updateWatchFace location is functioning correctly.
     */
    public void testUpdateLocation() {
        ...
        TestUtilities.validateCursor("testUpdateLocation.  Error validating location entry updateWatchFace.",
